...
'<table id="board">' + '\n' + 
	...
	'</tr>' + '\n' +
	'<tr>' + '\n' + 
		'<td style="height:185px; width:375px" valign="top"><div id="topCustomersL" style="border:1px solid blue;background-color: #EEE9E9"></div></td>' + '\n' + 
		'<td style="height:185px; width:375px" valign="top"><div id="topProfitL" style="border:1px solid blue;background-color: #EEE9E9" ></div></td>' + '\n' + 
		'<td style="height:185px; width:375px" valign="top"><div id="topUnfulfilledL" style="border:1px solid blue;background-color: #EEE9E9" ></div></td>' + '\n' + 
	'</tr>' + '\n' + 
